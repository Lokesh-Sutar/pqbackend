...
def create_finance_agent() -> Agent:
    return Agent(
        ...
        instructions=[
            ...
            'Output: Your final output MUST be a single JSON object. Do not add any conversational text. The JSON must follow this exact structure: {"ticker": "SYMBOL", "technical_analysis": [{"indicator_name": "NAME", "signal": "SIGNAL", "justification": "..."}], "summary": {"consolidated_signal": "SIGNAL/Mixed", "report": "..."}}',
        ],
        name='Finance_Agent',
        id='agent_1',
