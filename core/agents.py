...
def create_finance_agent() -> Agent:
    return Agent(
        ...
        instructions=[
            ...
            'Output: Provide a clear technical analysis report with consolidated signal and reasoning for each indicator.',
            'Format: Use clear, structured text. Avoid JSON or code blocks.',
        ],
        markdown=True,
        name='Finance_Agent',
        id='agent_1',
...
def create_sentiment_agent() -> Agent:
    return Agent(
        ...
        instructions=[
            ...
            'Output: Provide a comprehensive sentiment analysis with overall sentiment, confidence level, and key market drivers.',
            'Format: Use clear, structured text. Avoid JSON or code blocks.',
        ],
        tools=[
